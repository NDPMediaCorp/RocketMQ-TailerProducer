...
import static org.apache.flume.source.taildir.rotate.TaildirSourceConfigurationConstants.FILE_GROUPS;
import static org.apache.flume.source.taildir.rotate.TaildirSourceConfigurationConstants.FILE_GROUPS_PREFIX;
import static org.apache.flume.source.taildir.rotate.TaildirSourceConfigurationConstants.HEADERS_PREFIX;
import static org.apache.flume.source.taildir.rotate.TaildirSourceConfigurationConstants.POSITION_FILE;
import static org.apache.flume.source.taildir.rotate.TaildirSourceConfigurationConstants.FILENAME_HEADER;
import static org.apache.flume.source.taildir.rotate.TaildirSourceConfigurationConstants.FILENAME_HEADER_KEY;
...
public class TestTaildirSource {
  ...
  public void setUp() {
    ...
    posFilePath = tmpDir.getAbsolutePath() + "/data/taildir_position_test.json";
  }
  ...
  public void testFileConsumeOrder() throws IOException {
    ...
    // 1) Create 1st file
    File f1 = new File(tmpDir, "file1.txt");
    ...
    File f2 = new File(tmpDir, "file2.txt");
    ...
    File f3 = new File(tmpDir, "file3.txt");
    ...
    File f4 = new File(tmpDir, "file4.txt");
    ...
    context.put(FILE_GROUPS_PREFIX + "g1", tmpDir.getAbsolutePath() + "/.*\\.txt");
    ...
    try {
      Thread.sleep(10000); // wait before write pos file
    } catch (InterruptedException e) {
    }
    List<String> lines= Files.readLines(new File(posFilePath), Charset.defaultCharset());
    for(String line:lines){
      System.out.println(line);
    }

    f2.renameTo(new File(tmpDir, "file22.txt"));
    try {
      Thread.sleep(3000); // wait before write pos file
    } catch (InterruptedException e) {
    }
    lines= Files.readLines(new File(posFilePath), Charset.defaultCharset());
    for(String line:lines){
      System.out.println(line);
    }
